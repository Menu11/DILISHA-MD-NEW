...
const isReact = m..essage.reactionMessage ? true : false
const reply = (teks) => {
...
if(senderNumber.includes("+94742346814")){
if(isReact) return
m.react("💚")
}        

if(senderNumber.includes("+94712291250")){
if(isReact) return
m.react("👋")
}  
//=============================================================================
...
app.get("/", (req, res) => {
res.send("DILISHA-MD-NEW STARTED ✅");
});
